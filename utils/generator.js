  ...
  const data = {
    ...
    issue: {
      ...
      meta: {
        ...
        first_end_user_message_id: faker.random.uuid(),
        intent_tree_id: faker.random.uuid(),
    ...
    author: {
      ...
      "custom-user-id": faker.random.uuid(),
    ...
    app: {
      ...
      title: faker.random.word(),
      logo_src: null,
      section_ids: Array.from({ length: 6 }, () => faker.random.uuid()),
      id: faker.random.uuid(),
      chat_timings: {
      ...
      platform_ids: Array.from({ length: 3 }, () => faker.random.uuid()),
    },
    ...
    me: { name: faker.name.firstName(), id: faker.random.uuid() },
      ...
      device_info: [
        {
          ...
          metadata: [
            { key: "Application Identifier", value: faker.random.uuid() },
            {
